...
\ ['rg', '--files', '--glob', '!.git', '--ignore-file',  '.gitignore'])
...
"AIRLINE"
"""""""""
" let g:response = system("curl -s -X GET 'https://covid2019-api.herokuapp.com/country/us' | awk -F '{' '{print $3}' | awk -F '}' '{print $1}' | sed 's/\"//' | sed 's/,/ /g'")
" echo response
...
vmap <silent> <leader> gu <plug>(coc-format-select)
